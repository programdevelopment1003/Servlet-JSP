<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    int lastid = (int)session.getAttribute("a_lastid");
...
<%}else{	%>
<form name="form" action="NewAuthor" method="POST" >
	<h1>新規著者登録</h1><br><br>
	<h2>著者ID：<%=lastid %></h2><br>
	著者名：<input type="text" placeholder="" name="a_name"><br>
